...
const googleComputeRegionDiskResourcePolicyAttachment = `{
  "block": {
    "attributes": {
      "disk": {
...
func GoogleComputeRegionDiskResourcePolicyAttachmentSchema() *tfjson.Schema {
	var result tfjson.Schema
	_ = json.Unmarshal([]byte(googleComputeRegionDiskResourcePolicyAttachment), &result)
	return &result
}
