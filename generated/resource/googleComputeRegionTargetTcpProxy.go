...
const googleComputeRegionTargetTcpProxy = `{
  "block": {
    "attributes": {
      "backend_service": {
...
func GoogleComputeRegionTargetTcpProxySchema() *tfjson.Schema {
	var result tfjson.Schema
	_ = json.Unmarshal([]byte(googleComputeRegionTargetTcpProxy), &result)
	return &result
}
