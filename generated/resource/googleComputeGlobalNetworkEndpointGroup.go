...
const googleComputeGlobalNetworkEndpointGroup = `{
  "block": {
    "attributes": {
      "default_port": {
...
func GoogleComputeGlobalNetworkEndpointGroupSchema() *tfjson.Schema {
	var result tfjson.Schema
	_ = json.Unmarshal([]byte(googleComputeGlobalNetworkEndpointGroup), &result)
	return &result
}
