...
const googleFolderAccessApprovalSettings = `{
  "block": {
    "attributes": {
      "active_key_version": {
...
func GoogleFolderAccessApprovalSettingsSchema() *tfjson.Schema {
	var result tfjson.Schema
	_ = json.Unmarshal([]byte(googleFolderAccessApprovalSettings), &result)
	return &result
}
