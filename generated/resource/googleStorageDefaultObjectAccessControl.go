...
const googleStorageDefaultObjectAccessControl = `{
  "block": {
    "attributes": {
      "bucket": {
...
func GoogleStorageDefaultObjectAccessControlSchema() *tfjson.Schema {
	var result tfjson.Schema
	_ = json.Unmarshal([]byte(googleStorageDefaultObjectAccessControl), &result)
	return &result
}
