...
const googleIdentityPlatformTenantOauthIdpConfig = `{
  "block": {
    "attributes": {
      "client_id": {
...
func GoogleIdentityPlatformTenantOauthIdpConfigSchema() *tfjson.Schema {
	var result tfjson.Schema
	_ = json.Unmarshal([]byte(googleIdentityPlatformTenantOauthIdpConfig), &result)
	return &result
}
