...
const googleIdentityPlatformInboundSamlConfig = `{
  "block": {
    "attributes": {
      "display_name": {
...
func GoogleIdentityPlatformInboundSamlConfigSchema() *tfjson.Schema {
	var result tfjson.Schema
	_ = json.Unmarshal([]byte(googleIdentityPlatformInboundSamlConfig), &result)
	return &result
}
